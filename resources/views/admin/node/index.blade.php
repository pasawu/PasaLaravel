...
<div class="ibox-content" id="node_box" style="display: none">
    <form class="form-horizontal m-t" method="post" action="{{url('admin/node/add')}}" id="addForm">
...
<div class="ibox-content" id="edit_box" style="display: none">
    <form class="form-horizontal m-t" method="post" action="{{url('admin/node/edit')}}" id="editForm">
...
<script type="text/javascript">
    var node_del_url = "{{url('admin/node/delete')}}";
    var box;
    var nowNode = null;
    ...
    function getTree(){
        layui.use(['tree', 'layer'], function(){
            ...
            $.getJSON("{{url('admin/node/indexdata')}}", function(res){
                if(111 == res.code){
                    window.location.reload();
                }
                layui.tree({

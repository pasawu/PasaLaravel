        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="{{url('admin/articles/edit',['id'=>$data['id']])}}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="image" id="image" type="hidden" value="{{$data['image']}}"/>
                            <div class="form-inline">
                                ...
                                <div class="input-group col-sm-3">
                                    <div id="sm">
                                        <a target="_blank" href="{{$data['image']}}"><img src="{{$data['image']}}" width="40px" height="40px"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="display: flex;align-items: center;">
                            ...
                            <div class="input-group col-sm-4">
                                <?php
                                showEditor("content",$data['content']);
                                ?>
                            </div>
                        </div>
